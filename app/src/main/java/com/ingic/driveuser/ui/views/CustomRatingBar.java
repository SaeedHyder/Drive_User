...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.drive_star;
    private int mStarOffResource = R.drawable.drive_star2;
    private int mStarHalfResource = R.drawable.drive_star;
